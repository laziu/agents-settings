...
- KO: fragments/mappings by default; finite predicates only when omission loses meaning, with sentence punctuation; rewrite generated `함/됨` endings unless in quoted/source text, code/API names, or lexical words; EN: gerunds/imperatives
...
- Task/status replies: outcome, changed paths, verification, risk/follow-up; omit routine skill steps unless unusual
